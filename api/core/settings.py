...
DBLOG_HOST = os.environ.get("DBLOG_HOST")
DBLOG_USER = os.environ.get("DBLOG_USER")
DBLOG_PASSWORD = os.environ.get("DBLOG_PASSWORD")
DBLOG_KEYSPACE = os.environ.get("DBLOG_KEYSPACE")
...
OTP_LIFETIME = int(os.environ.get("OTP_LIFETIME", "300"))
OTP_RESEND_PERIOD = int(os.environ.get("OTP_RESEND_PERIOD", "300"))
OTP_QUOTA_PER_DAY = int(os.environ.get("OTP_QUOTA_PER_DAY", "10"))
OTP_MAX_FAIL_CHECKS = int(os.environ.get("OTP_MAX_FAIL_CHECKS", "3"))
OTP_TRUSTED_CODE = os.environ.get("OTP_TRUSTED_CODE", "123456")

MAX_DAILY_LOGIN_FAIL = int(os.environ.get("MAX_DAILY_LOGIN_FAIL", "5"))
MIN_REUSE_PWD = int(os.environ.get("MIN_REUSE_PWD", "8"))

DAILY_CHANGE_PWD_QUOTA = int(os.environ.get("DAILY_CHANGE_PWD_QUOTA", "3"))
DAILY_RESET_PWD_QUOTA = int(os.environ.get("DAILY_RESET_PWD_QUOTA", "3"))

MAX_UNUSED_DATE_TO_DEACTIVATE = int(
    os.environ.get("MAX_UNUSED_DATE_TO_DEACTIVATE", "3")
)
